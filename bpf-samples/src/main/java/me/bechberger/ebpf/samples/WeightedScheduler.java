...
@BPF(license = "GPL")
@Property(name = "sched_name", value = "weighted_scheduler")
public abstract class WeightedScheduler extends BPFProgram implements Scheduler, Runnable {
    ...
    public static void main(String[] args) {
        try (var program = BPFProgram.load(WeightedScheduler.class)) {
